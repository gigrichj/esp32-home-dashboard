 ...
 *
 * Board pin configuration for Waveshare ESP32-S3-Touch-LCD-7.
 * Adapted from the ESP_Display_Panel custom-board template, filled in
 * with the verified pin mapping for this exact board (RGB LCD bus,
 * GT911 touch over I2C, CH422G IO expander for backlight/reset).
 */
#pragma once

#define ESP_OPEN_TOUCH 1 // 1 enables touch, 0 disables it
...
// --- Backlight (via CH422G IO expander) ---
...
// --- Post-init hooks: IO expander enable, LCD reset, touch reset ---
