...
static const uint8_t *glyphFor(char c) {
    ...
    case '(': { static const uint8_t g[7] = {0x02, 0x04, 0x04, 0x04, 0x04, 0x04, 0x02}; return g; }
    case ')': { static const uint8_t g[7] = {0x08, 0x04, 0x04, 0x04, 0x04, 0x04, 0x08}; return g; }
    case '<': { static const uint8_t g[7] = {0x00, 0x03, 0x0C, 0x10, 0x0C, 0x03, 0x00}; return g; }
    case '>': { static const uint8_t g[7] = {0x00, 0x18, 0x06, 0x01, 0x06, 0x18, 0x00}; return g; }
